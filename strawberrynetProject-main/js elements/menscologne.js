async function getdata() {
  let res = await fetch(`https://nodejs-website-strawberrynet.herokuapp.com/menscologne`);
  let data = await res.json();
  console.log(data);
  //console.log(data.menscolognepproducts);

  showdata(data.menscolognepproducts);
}
...
async function showlist() {
  ...
  console.log(data);
  console.log(data.menscolognepproducts);
  showdatainlist(data.menscolognepproducts);
}
...
async function showlistbypop() {
  ...
  console.log(data);
  console.log(data.menscolognepproducts);
  let arr = data.menscolognepproducts;
