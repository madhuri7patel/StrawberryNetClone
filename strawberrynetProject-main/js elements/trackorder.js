...
function selected() {
  let dispCont = document.getElementById("items");
  dispCont.innerHTML = null;
  dispCont.append(selec.value);
}

let cont112 = document.getElementById("products");
...
if (par == null) {
  ...
  par.forEach((p) => {
    ...
    price.innerText ="Rs."+ p.price;
    price.style.paddingRight="60px";
...
if (par == null) {
  ...
  h4.innerText = "Total items:-";
  let h41 = document.createElement("p");
  h41.innerHTML = null;
  h41.innerText = par.length;
  let h42 = document.createElement("p");
  h42.innerText = "items‎";
  var sum = 0;
  par.forEach((p) => {
    sum = sum + p.price;
  });
  let h43 = document.createElement("p");
  h43.innerHTML = null;
  h43.innerText = "INR";
  let h44 = document.createElement("p");
  h44.innerHTML = null;
