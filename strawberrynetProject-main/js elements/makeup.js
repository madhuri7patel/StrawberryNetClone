async function getdata() {
  let res = await fetch(`https://nodejs-website-strawberrynet.herokuapp.com/makeup`);
...
async function showlist() {
  ...
  console.log(data);
  console.log(data.makeupproducts);
  showdatainlist(data.makeupproducts);
}
